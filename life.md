...
<div class="snapshots">
  <figure>
    <img src="{{ '/assets/img/photos/2014-08-26-jerusalem-street.jpg' | relative_url }}"
         alt="Ester laughing in an olive sun hat on a Jerusalem street" loading="lazy">
    <figcaption>Jerusalem, 2014</figcaption>
  </figure>
  <figure>
    <img src="{{ '/assets/img/photos/2018-10-10-poolside-portrait.jpg' | relative_url }}"
         alt="Ester in a white headscarf and floral blouse, smiling" loading="lazy">
    <figcaption>2018</figcaption>
  </figure>
  <figure>
    <img src="{{ '/assets/img/photos/with-walking-stick-among-yellow-flowers.jpg' | relative_url }}"
         alt="Ester standing with a purple walking stick beside yellow flowers" loading="lazy">
    <figcaption>With her walking stick</figcaption>
  </figure>
  <figure>
    <img src="{{ '/assets/img/photos/ester-with-baby.jpg' | relative_url }}"
         alt="Ester holding an infant against a turquoise door" loading="lazy">
    <figcaption>Holding a baby</figcaption>
  </figure>
</div>
...
and that her poems “map the soul’s journey through unlikely friendships and the
tests of love.” Her poems and essays appeared in *The BeZine*, *The Times of
Israel* and Michael Dickel’s *Meta/Phor(e)/Play*, often with her artwork
beside them.
...
that she “supported peace in the region here with words and deeds, helped
